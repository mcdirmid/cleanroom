...
- [ ] When 100% statement coverage is achieved and verified, calling the `blame` tool is prohibited, the coverage log is completely empty (0 bytes, all lines including headers deleted), and the session concludes via the `submit` tool
