         ...
         Subagents=[
             {
                 ...
                 "Prompt": (
                     ...
                     f"     When verified, call submit (for multi-target sessions, pass --target <file>):\n"
                     f"       python3 update_with_ai/support/lib/cleanroom_mcp_client.py --session {role_name} submit [--target <file>]\n"
                     f"     If attributing defects to upstream dependencies via blame:\n"
                     f"       python3 update_with_ai/support/lib/cleanroom_mcp_client.py --session {role_name} blame [--target <file>] --blame-target <upstream_file> --explanation \"<reason>\"\n"
