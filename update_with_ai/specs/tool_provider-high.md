...
- Tool result: the structured outcome of executing a tool call — the content produced, a content ID for deduplication, and a flag indicating whether previous results with the same content ID are hidden.
