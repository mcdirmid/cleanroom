...
- [external] The configured runfiles directory (manifest files and tool-provider modules resolved from it); tool-provider modules resolved via importlib; an externally configured agent loop.
