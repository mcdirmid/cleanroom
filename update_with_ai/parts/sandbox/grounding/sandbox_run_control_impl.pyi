...
"""
    ...
    def initialize(self) -> None:
        """
PURPOSE:
Installs submit, fail, and check file tools unconditionally, advance tool when guide step mode is active, and blame tool when blame targets are configured
