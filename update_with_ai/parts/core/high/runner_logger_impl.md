...
When consuming log events, the runner logger writes single-line compact summaries to standard output and writes unbuffered verbose entries to the transcript log file.
