...
def _update_ai_node_clean_impl(ctx):
    ...
    _lines = [
        ...
        "    from update_with_ai.lib import program_asm",
        "    from update_with_ai.lib.dag_runner import DagRunner",
        ...
        "    from update_with_ai.lib.bazel_target import BazelTarget",
        "",
        "def main():",
        "    args = sys.argv[1:]",
...
_update_ai_node_clean_rule = rule(
    ...
    attrs = {
        ...
        "_dag_runner": attr.label(
            default = Label("//update_with_ai/lib:program_asm"),
            providers = [PyInfo],
        ),
    },
)
