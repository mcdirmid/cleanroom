...
def _update_ai_node_clean_impl(ctx):
    ...
    _lines = [
        ...
        "    from update_with_ai.parts.dag.lib.dag_storage import DagStorage, DagNode",
        ...
        "    from lib.dag_storage import DagStorage, DagNode",
...
def _update_ai_node_feedback_impl(ctx):
    ...
    _lines = [
        ...
        "    from update_with_ai.parts.systems.lib import bazel_openai_loop_asm",
        "    from update_with_ai.parts.loop.lib.loop import Loop",
        "    from update_with_ai.parts.dag.lib.dag_storage import FeedbackMessage, DagNode",
        "    from update_with_ai.parts.bazel.lib.bazel_target import BazelTarget",
        "except ImportError:",
        "    from lib import bazel_openai_loop_asm",
        "    from lib.loop import Loop",
        "    from lib.dag_storage import FeedbackMessage, DagNode",
        "    from lib.bazel_target import BazelTarget",
        "",
        "def main():",
        "    messages = sys.argv[1:]",
        ...
        "    try:",
        "        for m in messages:",
        "            runner.inject_node_feedback(target_node, FeedbackMessage(content=m))",
        "    except KeyboardInterrupt:",
        '        print("Interrupted.", file=sys.stderr)',
        "        sys.exit(130)",
        "    sys.exit(0)",
