...
- Input: a target node, the root of the subgraph to clean.
- No direct output: messages are routed to node stores via dag_storage.
...
**For each cleaning request, the client provides:**

- A target node, the root of the subgraph to clean.
