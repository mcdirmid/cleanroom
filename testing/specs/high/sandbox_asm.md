...
fulfills: sandbox
imports: sandbox_impl (sandbox), file_view_impl (file machinery), guide_delivery_impl (step-mode delivery), run_control_impl (verification and termination)

## Deltas

- Assembles the concrete tool implementations into the sandbox implementation.
- Supplies the file machinery, step-mode delivery, and verification and termination rules through factories to the sandbox.
