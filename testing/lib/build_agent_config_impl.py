"""
lib/build_agent_config_impl.py

Implementation of BuildAgentConfig (see build_agent_config.py).
...
class BuildAgentConfigImpl(BuildAgentConfig):
    """
    Implements BuildAgentConfig for agent_config targets in the Bazel workspace.
